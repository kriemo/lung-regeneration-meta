...
`scVI` is an unsupervised integration approach. It is also a precursor step to running `scANVI` below. It was successful in mixing all of the cell types, but appears to overmerge the cells. 
...
scanVI looks the best, although in general all of the integrations seemed to generally work.

At a clustering setting that produces 7 clusters, these can be labeled as:  
