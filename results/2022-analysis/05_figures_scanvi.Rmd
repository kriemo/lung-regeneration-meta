...
get_mean_zvals <- function(sce, genes, group = "clusters_9", subset = NULL, clip = 2.5){
  if(!is.null(subset)) {
...
zs <- get_mean_zvals(sce, gns, subset = c(3, 7, 1))
...
scanVI_all_zscores <- get_mean_zvals(sce, rownames(scanvi_avg_log2_expr))
scanVI_c17_zscores <- get_mean_zvals(sce, rownames(scanvi_avg_log2_expr), subset = c(1, 7))
scanVI_c137_zscores <- get_mean_zvals(sce, rownames(scanvi_avg_log2_expr), subset = c(1, 3, 7))
...
scvi_c137_zscores <- get_mean_zvals(sce, rownames(scvi_avg_log2_expr), subset = c(1, 3, 7))


out <- list(scanvi_avg_log2_expr = scanvi_avg_log2_expr, 
            scanvi_all_zscores = scanVI_all_zscores, 
            scanVI_c17_zscores = scanVI_c17_zscores,
            scanVI_c137_zscores = scanVI_c137_zscores,
            scvi_avg_log2_expr = scvi_avg_log2_expr,
            scvi_all_zscores = scvi_all_zscores,
            scvi_c17_zscores = scvi_c17_zscores,
            scvi_c137_zscores = scvi_c137_zscores)
...
openxlsx::write.xlsx(out, 
                     "tables/average_cell_statistics_v2.xlsx",
                     overwrite = TRUE)
